...
The cumulative distribution function (CDF) is shown in the following plots with the effects of changing parameters.
...
plot(x, qGI0(x, p_alpha=-1, p_gamma=1, p_Looks=1),  
     log="y", type="l", xlab="x", ylab="Quantiles",
     main="Quantile changing Gamma",col="skyblue", xlim=c(0,1))
lines(x, qGI0(x, p_alpha=-1, p_gamma=1, p_Looks=1), col="coral2")
lines(x, qGI0(x, p_alpha=-1, p_gamma=3, p_Looks=1), col="aquamarine3")
legend("topright", legend=c("g=1", "g=3", "g=10"), col=c("skyblue", "coral2", "aquamarine3"), lty=1)
```
