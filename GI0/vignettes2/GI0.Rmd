...
rGI0 function is used to simulate data from the GI0 distribution and create histograms to visualize the data distribution with the underlying density. Freedman-Diaconis rule to change size of blocks depending on sample size (100,500,1000)
